...
public class ComplexSocketServer {
	...
	private static Logger LOGGER = LoggerFactory.getLogger(ComplexSocketServer.class);
	...
	public static void main(String[] args) throws IOException {
		...
		final ComplexSocketServer simpleSocketServer = new ComplexSocketServer(port, socketDataHandler);

		simpleSocketServer.listen();
	}

	public ComplexSocketServer(int listenPort, SocketDataHandler handler) {
