...
antlr4 -Dlanguage=Python3 -o output_py ExGlobalVarLexer.g4
#OR antlr4j "ExGlobalVarLexer.g4"  -o "output_py" -Dlanguage=Python3 #the jar version should match with python wrapped version. pls check from the output lexer, e.g. # Generated from ExGlobalVarLexer.g4 by ANTLR 4.12.0
